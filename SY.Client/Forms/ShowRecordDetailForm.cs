...
{
    public partial class ShowRecordDetailForm : Form
    {
        ...
        public ShowRecordDetailForm(string categoryTableName, int archivesId)
        {
            InitializeComponent();
        ...
        public void initDisplayConditions()
        {
            ...
            insertColumnMsgs = ServerProxy.GetProxy().GetConfigValue(categoryTableName + ConfigType.ShowRecordDetail, LoginForm.LOGIN_USER_NAME);
        ...
        {
            new CustomizeForm(categoryTableName, ConfigType.ShowRecordDetail, null, null, this,null);
        }
